...
public class SkywardHarpItem extends MinecraftImpactModElements.ModElement {
	@ObjectHolder("minecraft_impact:skyward_harp")
	public static final Item block = null;
	@ObjectHolder("minecraft_impact:entitybulletskyward_harp")
	public static final EntityType arrow = null;
	public SkywardHarpItem(MinecraftImpactModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletskyward_harp").setRegistryName("entitybulletskyward_harp"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"\u00A7oA greatbow that symbolizes Dvalin's affiliation with the Anemo Archon. The sound of the bow firing is music to the Anemo Archon's ears. It contains the power of the sky and wind within."));
		}
