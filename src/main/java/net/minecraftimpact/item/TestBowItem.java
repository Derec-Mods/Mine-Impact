...
public class TestBowItem extends MinecraftImpactModElements.ModElement {
	@ObjectHolder("minecraft_impact:test_bow")
	public static final Item block = null;
	@ObjectHolder("minecraft_impact:entitybullettest_bow")
	public static final EntityType arrow = null;
	public TestBowItem(MinecraftImpactModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullettest_bow").setRegistryName("entitybullettest_bow"));
	}
