...
package net.minecraftimpact.block;
...
public class IronChunkOreBlock extends MinecraftImpactModElements.ModElement {
	@ObjectHolder("minecraft_impact:iron_chunk_ore")
	public static final Block block = null;
	public IronChunkOreBlock(MinecraftImpactModElements instance) {
		super(instance, 65);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("iron_chunk_ore");
		}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 5)).range(128).square().func_242731_b(5));
	}
}
