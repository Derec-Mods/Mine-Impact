...
public class WhiteIronOreBlock extends MinecraftImpactModElements.ModElement {
	@ObjectHolder("minecraft_impact:white_iron_ore")
	public static final Block block = null;
	public WhiteIronOreBlock(MinecraftImpactModElements instance) {
		super(instance, 57);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("white_iron_ore");
		}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(70).square().func_242731_b(4));
	}
}
