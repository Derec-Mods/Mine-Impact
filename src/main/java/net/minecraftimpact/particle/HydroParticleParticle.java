...
public class HydroParticleParticle extends MinecraftImpactModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public HydroParticleParticle(MinecraftImpactModElements instance) {
		super(instance, 23);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("hydro_particle"));
	}
