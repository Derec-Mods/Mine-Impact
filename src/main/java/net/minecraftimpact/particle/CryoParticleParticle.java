...
public class CryoParticleParticle extends MinecraftImpactModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public CryoParticleParticle(MinecraftImpactModElements instance) {
		super(instance, 24);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("cryo_particle"));
	}
