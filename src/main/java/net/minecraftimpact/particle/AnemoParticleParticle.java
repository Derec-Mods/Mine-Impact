...
public class AnemoParticleParticle extends MinecraftImpactModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public AnemoParticleParticle(MinecraftImpactModElements instance) {
		super(instance, 33);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("anemo_particle"));
	}
