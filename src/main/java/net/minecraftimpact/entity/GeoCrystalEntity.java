...
import net.minecraftimpact.procedures.ConsumeCrystalProcedure;
...
public class GeoCrystalEntity extends MinecraftImpactModElements.ModElement {
	public static EntityType entity = null;
	public GeoCrystalEntity(MinecraftImpactModElements instance) {
		super(instance, 26);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(1.2f, 1.2000000000000002f))
						.build("geo_crystal").setRegistryName("geo_crystal");
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgeocrystal(), 1f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_impact:textures/geoparticle.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				ConsumeCrystalProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
