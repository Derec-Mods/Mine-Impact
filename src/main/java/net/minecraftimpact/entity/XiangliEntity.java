...
import net.minecraftimpact.item.WhiteTasselItem;
...
public class XiangliEntity extends MinecraftImpactModElements.ModElement {
	public static EntityType entity = null;
	public XiangliEntity(MinecraftImpactModElements instance) {
		super(instance, 52);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("xiangli")
						.setRegistryName("xiangli");
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldefault6464(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_impact:textures/xiangli.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("Xiangling"));
			setCustomNameVisible(true);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(WhiteTasselItem.block, (int) (1)));
		}
