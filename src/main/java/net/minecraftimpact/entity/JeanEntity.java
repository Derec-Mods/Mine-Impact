...
public class JeanEntity extends MinecraftImpactModElements.ModElement {
	public static EntityType entity = null;
	public JeanEntity(MinecraftImpactModElements instance) {
		super(instance, 51);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("jean")
						.setRegistryName("jean");
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldefault6464(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_impact:textures/jean.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("Jean"));
