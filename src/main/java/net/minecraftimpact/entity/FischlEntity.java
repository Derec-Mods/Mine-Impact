...
import net.minecraftimpact.item.SkywardHarpItem;
...
public class FischlEntity extends MinecraftImpactModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("minecraft_impact:entitybulletfischl")
	public static final EntityType arrow = null;
	public FischlEntity(MinecraftImpactModElements instance) {
		super(instance, 45);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("fischl")
						.setRegistryName("fischl");
		elements.entities.add(() -> entity);
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletfischl").setRegistryName("entitybulletfischl"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("minecraft_impact:textures/fischl.png");
					}
				};
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("Fischl"));
			setCustomNameVisible(true);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(SkywardHarpItem.block, (int) (1)));
		}
